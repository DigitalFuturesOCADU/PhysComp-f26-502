...
## Arduino IDE Setup
- [Initial Board Setup](GetStarted.md)
- [Arduino IDE Guide](https://docs.arduino.cc/software/ide-v2/tutorials/getting-started-ide-v2/)
...
## Ebooks available through OCADU Library (requires login)
- [Learn Electronics with Arduino] (https://ebookcentral.proquest.com/lib/oculocad-ebooks/detail.action?docID=5057701)
- [Physical Computing](https://ebookcentral.proquest.com/lib/oculocad-ebooks/detail.action?docID=3135871)
...
- [What is a Circuit?](https://learn.sparkfun.com/tutorials/what-is-a-circuit/all)
- [How to Use a Breadboard](https://learn.sparkfun.com/tutorials/how-to-use-a-breadboard)

### Adafruit

- [Circuit Playground - Electronic ABCs](https://learn.adafruit.com/groups/circuit-playground)
